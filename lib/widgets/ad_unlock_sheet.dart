    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            lang == 'es' ? 'Desbloquear artículo' : 'Unlock Article',
          ...
          Text(
            lang == 'es'
                ? 'Mira 2 anuncios cortos para leer este artículo'
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: isDone
                      ? const LinearGradient(
                          colors: [KokColors.success, Color(0xFF059669)],
                        )
                      : isCurrent
                          ? const LinearGradient(
                              colors: [KokColors.gradientStart, KokColors.gradientEnd],
                  ...
                  border: (!isDone && !isCurrent)
                      ? Border.all(color: KokColors.border)
                      : null,
                ),
                child: Icon(
